...
extends PacketCheck {
    ...
    public AutoClickerI() {
        super(Check.CheckType.AUTO_CLICKERI, "I", "AutoClicker", Check.CheckVersion.RELEASE);
        this.setMaxViolation(InsaneAC.getInstance().getAlerts().getInt("CheckTypes.AutoClicker I.Alerts"));
        this.violations = -2.0;
    }
