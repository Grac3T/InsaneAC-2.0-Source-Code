...
extends Gui {
	...
	public OtherGui() {
        ...
        for (Check.CheckType type : Check.CheckType.values()) {
        	if (type.getSuffix().equals("Other")) {
            	...
            	checkMeta.setLore((List)Arrays.asList("§8§m--------------------", "§eSoon...", "§8§m--------------------"));
    ...
    public void onClick(ClickData clickData) {
        ...
        if (slot <= this.getInventory().getSize() && slot >= 0) {
            ...
            if (checkStack.getItemMeta().getDisplayName().equalsIgnoreCase("§6Back")) {
